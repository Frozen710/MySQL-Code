...
-- This is the less commonly used way - which is to build it exactly like a real table and insert data into it
...
-- Build it by inserting data into it - easier and faster
